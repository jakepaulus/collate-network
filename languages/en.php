...
# common terms
  ...
  "inputtooshort"          => "This value must be at least three characters long.",
...
// _blocks.php
  ...
  "shortblock"        => "Block names must be three characters or longer.",
...
// blocks.php
  "blocknamehelp"       => "Enter the name of the IP block here. The name should be descriptive of what the subnets inside 
                            the block will be used for. The name should be short and should not contain spaces.",
  ...
  "blockoverlap-notice" => "The IP block you entered overlaps with an existing IP block in the database.",
...
// _subnets.php
  "shortsubnetname" => "Subnet names must be between 3 and 60 characters.", #also used as a notice in subnets.php
...
#
 "footertext" => "Collate:Network &copy; 2007 - 2012 by its <a href=\"http://collate.info/\">developers</a><br />
